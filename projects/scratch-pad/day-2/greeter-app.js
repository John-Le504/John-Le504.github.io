...
function greeter(hour) {
    ...
    // if-else statement that prints a greeting depending on the hour
    if (hour >= 0 && hour <=11){ //print good morning if hour is between 0 and 11
        console.log("Good Morning!");
    }
    else if (hour >= 12 && hour <= 16){ //print good afternoon if hours is between 12 and 16
        console.log("Good Afternoon!");
    }
    else if (hour >= 17 && hour <= 21){ //print good evening if hours is between 17 and 21
        console.log("Good Evening!");
    }
    else console.log("Good Night!"); //print goodnight otherwise
